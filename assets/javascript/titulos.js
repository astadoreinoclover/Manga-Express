...
function menoscampos() {
        document.querySelector('.mais').classList.add('none');
}

function maiscampos() {
    if(document.querySelector('.mais').classList.contains('none')) {
        document.querySelector('.mais').classList.remove('none');
    }
}
